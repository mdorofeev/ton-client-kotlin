...
class CryptoModuleTest : StringSpec({
    ...
    "Should be able call crypto.nacl_sign_keypair_from_secret_key" {
        ...
        val response = client.crypto.naclSignKeypairFromSecretKey("db5da80d3bdeb607d17cf29d1c68489b5071637b3a0d8d747b7ad6ce7e89e5c0")
    ...
    "Should be able call crypto.nacl_sign" {
        ...
        val response = client.crypto.naclSign("test","56b6a77093d6fdf14e593f36275d872d75de5b341942376b2a08759f3cbae78f1869b7ef29d58026217e9cf163cbfbd0de889bdf1bf4daebf5433a312f5b8d6e")
    ...
    "Should be able call crypto.nacl_sign_open" {
        ...
        val response = client.crypto.naclSignOpen("iqgAXl0PpQ1kZ1FPQmOPHj377RXJzEnXZW1aklWin1NqKMbpDJiMNiskpOQl23oM3sIq8yFv8PedCZGKA3ZtBrXrLQ==","1869b7ef29d58026217e9cf163cbfbd0de889bdf1bf4daebf5433a312f5b8d6e")
    ...
    "Should be able call crypto.nacl_sign_detached" {
        ...
        val response = client.crypto.naclSignDetached("test","56b6a77093d6fdf14e593f36275d872d75de5b341942376b2a08759f3cbae78f1869b7ef29d58026217e9cf163cbfbd0de889bdf1bf4daebf5433a312f5b8d6e")
    ...
    "Should be able call crypto.nacl_box and nacl_box_open" {
        ...
        val params = ParamsOfNaclBox(decrypted, "cd7f99924bf422544046e83595dd5803f17536f5c9a11746",
    ...
    "Should be able call crypto.nacl_secret_box and nacl_secret_box_open" {
        ...
        val params = ParamsOfNaclSecretBox(decrypted, "cd7f99924bf422544046e83595dd5803f17536f5c9a11746",
            "c4e2d9fe6a6baf8d1812b799856ef2a306291be7a7024837ad33a8530db79c6b")
